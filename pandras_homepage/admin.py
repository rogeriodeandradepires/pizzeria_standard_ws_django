...
class PandrasAdminSite(AdminSite):
    site_header = "PANDRAS Admin"
    site_title = "PANDRAS Admin Portal"
    index_title = "Bem-vindo ao Portal de Administração do app PANDRAS"
