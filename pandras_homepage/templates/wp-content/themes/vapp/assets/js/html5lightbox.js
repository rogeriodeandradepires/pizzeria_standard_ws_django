...
(function() {
    ...
    for (var i = 0; i < scripts.length; i++)
        if (scripts[i].src && scripts[i].src.match(/html5lightbox\.js/i)) jsFolder = scripts[i].src.substr(0, scripts[i].src.lastIndexOf("https://puzzlelab.com.br/") + 1);
...
function loadHtml5LightBox(jsFolder) {
    (function($) {
        $.fn.html5lightbox = function(options) {
            ...
            inst.options.htmlfolder = window.location.href.substr(0, window.location.href.lastIndexOf("https://puzzlelab.com.br/") + 1);
            inst.options.skinsfolder = inst.options.skinsfoldername;
            if (inst.options.skinsfolder.length > 0 && inst.options.skinsfolder[inst.options.skinsfolder.length - 1] != "https://puzzlelab.com.br/") inst.options.skinsfolder += "https://puzzlelab.com.br/";
            if (inst.options.skinsfolder.charAt(0) != "/" && inst.options.skinsfolder.substring(0, 5) != "http:" && inst.options.skinsfolder.substring(0, 6) != "https://puzzlelab.com.br/") inst.options.skinsfolder =
            ...
            inst.showVideo = function(elem) {
                ...
                inst.resizeLightbox(dataW, dataH, true, function() {
                    ...
                    if (isHTML5) {
                        ...
                        if (videoFile.charAt(0) != "/" && videoFile.substring(0, 5) != "http:" && videoFile.substring(0, 6) != "https://puzzlelab.com.br/") videoFile = inst.options.htmlfolder + videoFile;
            ...
            inst.prepareYoutubeHref = function(href) {
                ...
                var protocol = "https://puzzlelab.com.br/";
            ...
            inst.showPDF = function(elem) {
                if (inst.options.enablepdfjs) {
                    ...
                    var href = elem[ELEM_HREF];
                    if (href.substring(0, 5) != "http:" && href.substring(0, 6) != "https://puzzlelab.com.br/") href = inst.absoluteUrl(href);
            ...
            inst.isSameDomain = function(href) {
                if (href.substring(0, 5) != "http:" && href.substring(0, 6) != "https://puzzlelab.com.br/") return true;
